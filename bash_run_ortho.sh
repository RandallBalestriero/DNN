...
export CUDA_VISIBLE_DEVICES=0;nohup bash -c "(python run_ortho.py CIFAR100 1 0.0005 2 0 > cifar100_0005_0_2.out) &> cpython100_0005_0_2.out" &
sleep 10s
export CUDA_VISIBLE_DEVICES=1;nohup bash -c "(python run_ortho.py CIFAR100 0 0.0005 2 0 > cifar100_0005_1_2.out) &> cpython100_0005_1_2.out" &
sleep 10s
